                    ...
                    <div class="row g-0">
                        ...
                        <div class="col-md-8">
                            <div class="card-body">
                                ...
                                <p class="card-text">Tahun Rilis:<br><?= $result['release_year'] ?></p>
                                <p class="card-text">Stok:<br><?= $result['stock'] ?></p>
                                <p class="card-text">Harga:<br><?= $result['price'] ?></p>
                                <p class="card-text">Diskon:<br><?= $result['discount'] ?></p>
